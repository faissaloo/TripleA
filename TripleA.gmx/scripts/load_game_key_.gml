...
for(iii=0;iii<string_length(file_text_read_string(_file));iii+=1)
{
    //show_message(iii)
    ...
    if string_char_at(file_text_read_string(_file),iii)=";"
    {
        ...
        if current_string=argument0
        {
            ...
            //file_text_close(_file)
            //_file=0
            break; //Replaced old 'return value' with a break because maybe the sphaggeti code was causing the issues
